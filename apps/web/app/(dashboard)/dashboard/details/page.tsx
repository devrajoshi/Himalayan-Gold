    ...
    return (
        <div className="space-y-12">
            <header>
                ...
                <p className="text-muted-foreground font-medium">Update your personal information and manage your security settings.</p>
            </header>
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
                    ...
                    <div className="bg-background rounded-3xl p-10 shadow-sm border border-muted">
                        ...
                        <form className="space-y-6">
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                                <div>
                                    <label className="block text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2">First Name</label>
                                    <input
                                ...
                                <div>
                                    <label className="block text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2">Last Name</label>
                                    <input
                                        className="w-full bg-background border-muted rounded-xl focus:ring-1 focus:ring-primary focus:border-primary p-4 outline-none transition-all"
                                        type="text"
                    ...
                    <div className="bg-background rounded-3xl p-10 shadow-sm border border-muted">
                        ...
                        <form className="space-y-6">
                            <div className="space-y-6 max-w-md">
                                <div>
                                    <label className="block text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2">Current Password</label>
                                    <input
                                        className="w-full bg-background border-muted rounded-xl focus:ring-1 focus:ring-primary focus:border-primary p-4 outline-none transition-all"
                                        type="password"
                                        placeholder="••••••••"
                                ...
                                <div>
                                    <label className="block text-xs font-bold uppercase tracking-widest text-muted-foreground mb-2">Confirm New Password</label>
                                    <input
                                        className="w-full bg-background border-muted rounded-xl focus:ring-1 focus:ring-primary focus:border-primary p-4 outline-none transition-all"
                                        type="password"
                                        placeholder="••••••••"
                            ...
                            <div className="pt-4">
                                <Button variant="outline" className="border-forest text-forest dark:text-primary dark:border-primary font-bold py-6 px-10 rounded-xl hover:bg-forest/10 transition-all">
                                    Update Password
                                </Button>
                            </div>
                        </form>
                ...
                <aside className="space-y-8">
                    <div className="bg-primary/5 border border-primary/20 rounded-3xl p-8 backdrop-blur-sm">
                        <h3 className="font-display text-xl font-bold text-forest dark:text-white mb-4">Profile Privacy</h3>
                        <p className="text-sm text-muted-foreground leading-relaxed mb-6">
                            Your personal data is encrypted and used only for order processing and loyalty rewards. We never share your information with third parties.
                        </p>
                    ...
                    <div className="bg-background rounded-3xl p-8 border border-muted shadow-sm text-center">
                        ...
                        <h4 className="font-display text-xl font-bold text-forest dark:text-white">Alexander Sterling</h4>
                        <p className="text-sm text-muted-foreground mb-6">Member since October 2022</p>
                        <Button variant="outline" className="w-full border-muted text-muted-foreground hover:bg-muted/50 rounded-xl">
                            Change Avatar
                        </Button>
                    </div>
                </aside>
