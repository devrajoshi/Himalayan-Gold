import { ArrowUpRight, Clock, Coins, Gift, Star, Trophy } from "lucide-react";
...
export default function RewardsPage() {
  const rewardsHistory = [
    {
      activity: "Purchase: Royal Sidr Reserve",
      date: "Oct 24, 2023",
      points: "+150",
      type: "earn",
    },
    {
      activity: "Review: Wildflower Blossom",
      date: "Oct 20, 2023",
      points: "+50",
      type: "earn",
    },
    {
      activity: "Redeemed: $10 Voucher",
      date: "Oct 15, 2023",
      points: "-500",
      type: "spend",
    },
    {
      activity: "Purchase: Spring Meadows",
      date: "Sep 12, 2023",
      points: "+200",
      type: "earn",
    },
  ...
  const availableRewards = [
    {
      title: "$10 Discount",
      cost: "500 pts",
      description: "Use on any order over $50",
    },
    {
      title: "Free Shipping",
      cost: "300 pts",
      description: "Standard shipping on your next order",
    },
    {
      title: "Medicinal Spoon",
      cost: "800 pts",
      description: "Handcrafted wooden honey spoon",
    },
  ];
    ...
    <div className="space-y-12">
      <header>
        ...
        <p className="text-muted-foreground font-medium">
          Track your points, unlock tiers, and redeem exclusive rewards.
        </p>
      </header>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-background border-2 border-primary/30 rounded-3xl p-8 shadow-sm">
          <h3 className="font-display text-xl font-bold text-forest dark:text-white mb-6">
            How it works
          </h3>
            ...
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  1 point for every $1 spent in our store.
                </p>
              </div>
            </li>
            <li className="flex gap-4">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Unlock limited edition harvests and gifts.
                </p>
              </div>
            </li>
          </ul>
          <Button
            variant="outline"
            className="w-full mt-8 border-primary text-primary hover:bg-primary/10"
          >
        ...
        <section className="lg:col-span-2 space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {availableRewards.map((reward, i) => (
              <div
                key={i}
                className="bg-background rounded-2xl p-6 border border-muted shadow-sm hover:border-primary/50 transition-all group"
              >
                <div className="flex justify-between items-start mb-4">
                  <div className="p-3 bg-muted rounded-xl group-hover:bg-primary/10 transition-colors">
                    <Gift className="text-primary w-6 h-6" />
                  </div>
                  <span className="text-lg font-bold text-forest dark:text-primary">
                    {reward.cost}
                  </span>
                </div>
        ...
        <aside className="space-y-8">
          <div className="bg-background rounded-3xl p-8 border border-muted shadow-sm overflow-hidden">
            ...
            <div className="space-y-6">
              {rewardsHistory.map((item, i) => (
                <div
                  key={i}
                  className="flex justify-between items-start pb-4 border-b border-muted last:border-0 last:pb-0"
                >
                  <div>
          ...
          <div className="bg-gradient-to-br from-primary to-primary/80 rounded-3xl p-8 text-forest relative overflow-hidden">
            ...
            <p className="text-sm font-medium mb-6">
              Earn 500 bonus points for every friend who makes their first purchase.
            </p>
            <Button className="w-full bg-forest text-primary font-bold rounded-xl border-none">
              Get Invite Link
            </Button>
          </div>
        </aside>
