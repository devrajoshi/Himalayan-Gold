...
export default function DashboardOverview() {
    ...
    const recentOrders = [
        { id: "#HG-98421", date: "Oct 24, 2023", status: "Delivered", total: "$142.00" },
        { id: "#HG-97210", date: "Sep 12, 2023", status: "Shipped", total: "$89.00" },
        { id: "#HG-96554", date: "Aug 05, 2023", status: "Delivered", total: "$214.50" },
    ];
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                ...
                <aside className="space-y-8">
                    <div className="bg-forest rounded-3xl p-8 text-white relative overflow-hidden group shadow-xl">
                        ...
                        <h4 className="font-display text-2xl font-bold mb-4">{content.dashboard.harvest.title}</h4>
                    ...
                    <div className="bg-background rounded-3xl p-8 border border-muted shadow-sm">
                        <h4 className="font-display text-xl font-bold text-forest dark:text-white mb-4">Reward Progress</h4>
                        ...
                        <p className="text-xs text-muted-foreground font-medium">550 points until your next Platinum tier unlock.</p>
                    </div>
                </aside>
            </div>
        </div>
