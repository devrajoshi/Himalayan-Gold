...
export function HexagonBackground({
    ...
    return (
        <div
            ref={containerRef}
            className={cn("absolute inset-0 min-h-full overflow-x-hidden bg-neutral-950", className)}
        >
            {/* Hexagon grid */}
            ...
            {/* Content layer — fully pass-through; only links/buttons receive events */}
            {children && (
                <div className="pointer-events-none relative z-10 h-full w-full [&_a]:pointer-events-auto [&_button]:pointer-events-auto">
                    {children}
                </div>
            )}
        </div>
