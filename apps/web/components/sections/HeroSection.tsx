      ...
      >
        <div className="pointer-events-none container mx-auto px-6 flex flex-col lg:flex-row items-center relative z-10 pt-40 pb-32">
          <div className="lg:w-1/2 text-center lg:text-left">
            <p className="font-script text-primary text-4xl mb-4 animate-in fade-in slide-in-from-bottom-4 duration-500">
              {script}
            </p>
            ...
            <div className="pointer-events-auto flex flex-col sm:flex-row gap-6 justify-center lg:justify-start">
              <Button
                asChild
                size="lg"
                className="bg-primary text-neutral-950 font-bold py-8 px-12 rounded-xl hover:bg-primary/90 hover:scale-105 transition-all text-lg"
              >
              ...
              <Button
                ...
                asChild
                size="lg"
                className="bg-transparent border-primary/50 text-white font-bold py-8 px-12 rounded-xl hover:bg-primary hover:text-neutral-950 transition-all text-lg"
              >
              ...
              {stats.map((stat, i) => (
                <div key={stat.label} className="flex items-center gap-12">
                  <div className="text-center">
                    ...
                    <p className="text-xs uppercase tracking-[0.2em] font-medium text-white/50">
                      {stat.label}
                    </p>
                  </div>
                  {i < stats.length - 1 && (
