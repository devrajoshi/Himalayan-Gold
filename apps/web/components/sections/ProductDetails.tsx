        ...
        <main className="pt-24 min-h-screen bg-background transition-colors duration-300">
            ...
            <nav className="container mx-auto px-6 py-4">
                <ol className="flex items-center space-x-2 text-sm text-muted-foreground">
                    ...
                    <li><Link className="hover:text-primary" href="/#shop">Shop Honey</Link></li>
                    <li><ChevronRight size={14} /></li>
                            ...
                            <div className="flex items-center">
                                {[...Array(5)].map((_, i) => (
                                    <Star
                                        key={i}
                                        size={20}
                                        className={i < Math.floor(product.reviews[0]?.rating || 5) ? "fill-primary text-primary" : "text-muted-foreground"}
                                    />
                                ))}
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-12">
                        {product.purityDetails.map((detail, i) => (
                            <div key={i} className="flex flex-col items-center text-center group">
                                ...
                                <h3 className="font-display text-xl font-bold mb-2 text-foreground">{detail.title}</h3>
            ...
            <section className="py-24 honeycomb-bg">
                <div className="container mx-auto px-6">
                    <div className="flex flex-col lg:flex-row items-center gap-16">
                        <div className="lg:w-1/2">
                            <p className="font-script text-primary text-4xl mb-4">{product.story.title.split(' ')[0]}</p>
            ...
            <section className="py-20 bg-forest text-white">
                <div className="container mx-auto px-6">
                    <div className="max-w-4xl mx-auto">
                        <h3 className="font-display text-3xl font-bold mb-10 text-center text-primary">Harvest Details</h3>
                ...
                <div className="container mx-auto px-6">
                    <div className="flex items-end justify-between mb-12">
                        <div>
                            ...
                            <h2 className="font-display text-4xl font-bold text-forest dark:text-white">You May Also Like</h2>
                        </div>
                    </div>
