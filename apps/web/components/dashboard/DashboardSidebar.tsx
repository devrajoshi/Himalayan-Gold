      ...
      <div className="flex flex-col h-full overflow-hidden">
                  ...
                  >
                    <Icon
                      className={cn(
                        ...
                        isActive
                          ? "text-forest"
                          : "text-white/70 group-hover:text-primary hover:scale-110",
                      )}
                    />
        ...
        <div className="p-4 mt-auto border-t border-white/5 overflow-hidden">
          <button
            ...
            className={cn(
              "w-full flex items-center gap-4 p-4 rounded-xl text-white/60 hover:text-white hover:bg-white/5 transition-colors group",
              isCollapsed && "justify-center px-0",
            )}
