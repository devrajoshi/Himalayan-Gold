...
export const products: Product[] = [
  {
    ...
    fullDescription:
      "A liquid treasure born from the ancient Sidr trees of the Himalayan valleys. This rare harvest boasts a deep, soulful amber hue and a velvety texture that carries the potent medicinal essence of the mountains.",
    tag: "Medicinal Grade",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuAnrbtWCwAGWwf6JFKN5wu4eVwgUC_7LSLD9A-l3wKuBk5TKFC3iRcMCT_W7NS9bzBMWie6fJ6gPTLeb7IhCh5t7qVlVYXetyomXjp4TdV44I-eLp6iDg67ni3M-SiMm84O-iitV6J_b93_SBQ3y6CRZsUSK-r1pIaO7UkJd7ceoW3iMZLwZk9IOD0yEfqG_Exzt79lNPWDVo9vLxhKUMoOYfPRmNf1IaB7xkfLY2RoAAkPu1ofblOfgK1F1M8dEieaQeaLMdHidW0",
    ...
    purityDetails: [
      {
        title: "Lab Tested",
        description:
          "Every batch is rigorously tested for purity and MGO levels in independent laboratories.",
        icon: "science",
      },
      {
        title: "Wild Harvested",
        description:
          "Collected by traditional climbers from wild hives nestled in remote high-altitude cliffs.",
        icon: "eco",
      },
      {
        title: "High Pollen Count",
        description:
          "Rich in bioactive compounds and diverse floral pollen from the sacred Sidr groves.",
        icon: "nature",
      },
    ],
    reviews: [
      {
        ...
        rating: 5,
        comment:
          "I've tried honey from all over the world, but the Himalayan Gold Sidr reserve is on another level. The complexity of flavors is astounding and it feels incredibly healing.",
      },
      {
        name: "Marcus Thorne",
        rating: 5,
        comment:
          "Absolutely worth every penny. You can really feel the difference in quality compared to supermarket raw honey. A true premium experience.",
      },
    ],
    story: {
      ...
      image:
        "https://lh3.googleusercontent.com/aida-public/AB6AXuBKb1MKujYxlnbqrKQFq-aFVgb_iKE6wZRt4GiO3gU0mLRZOMPM_d5BvlqHvpXPo92QlcmJtplwF2fvD106QnCpwfjrjFd42LXRT7ZfBswWKGo2hRexpftf_-Fb8hvBb38sSqZFV4lXRuifV_SXcqFGVtd2taerE-aP0SIPqRppsIkyi5PmpwkU1em3A4t3n1d3ss7J6EngQTadZr3yuOK3lTIiaUUcEm5y1ntBaf6OvYrEBP5xVS0ED3ehfUBh5xent-ydQfwI3fY",
    },
  },
  {
    id: "1",
    ...
    fullDescription:
      "A delicate symphony of floral notes captured from the untamed wildflowers of the lower Himalayan slopes. This honey is light, aromatic, and bursting with the vitality of the spring bloom.",
    image:
      "https://lh3.googleusercontent.com/aida-public/AB6AXuB2Aof232WBcT9vUxgGGELeYnhWZPpL5SXIMlo55N95DRtVDEiz-iwdQ41cdcnEtZ00rTqD9XKBX0aWIqBpQpQ1uYviKbfcZ3wcq6eAWR8r60QBd5Ww5Sr-7gZB9dnyhqkLv_nnnPpxiHOuHZa7m7a3bJaudZGx0J1-loArJjd9fWGdJf-m1jdAwTv3KGRgVqBH3hCz7uAAK2SFGSagDhdrWPdnJGH72gCgob9Tv6rj_TIAtNivxCjh06wgERkvQaVJ9JLh-rsyw8A",
    altitude: "3,200m",
